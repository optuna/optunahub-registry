...
def get_bayesmark_func(model_name, task_type, y_train=None):
    ...
    if model_name == "RandomForest":
        if task_type == "classification":
            ...
            return partial(
                RandomForestClassifier, n_estimators=10, max_leaf_nodes=None, random_state=0
            )  # following Bayesmark implementation
        elif task_type == "regression":
            from sklearn.ensemble import RandomForestRegressor

            return partial(
                RandomForestRegressor, n_estimators=10, max_leaf_nodes=None, random_state=0
            )
