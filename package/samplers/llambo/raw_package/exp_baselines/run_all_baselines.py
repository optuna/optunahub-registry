...
ALL_BO_MODELS = [
    {
        ...
        "name_experiment": "TPE (Random init)",
        "bo_type": "bo_tpe",
    }
]
ALL_BO_MODELS += [
    {
        "template_object": RandomTemplate(),
        "name_experiment": "GP (Random init)",
        "bo_type": "bo_gp",
    }
]
ALL_BO_MODELS += [
    {
        "template_object": RandomTemplate(),
        "name_experiment": "GP DKL (Random init)",
        "bo_type": "bo_dkl",
    }
]
ALL_BO_MODELS += [
    {
        "template_object": RandomTemplate(),
        "name_experiment": "SMAC (Random init)",
        "bo_type": "bo_smac",
    }
]
ALL_BO_MODELS += [
    {
        "template_object": RandomTemplate(),
        "name_experiment": "SKOPT (Random init)",
        "bo_type": "bo_skopt",
    }
]
ALL_BO_MODELS += [
    {
        "template_object": RandomTemplate(),
        "name_experiment": "Turbo (Random init)",
        "bo_type": "bo_turbo",
    }
]
ALL_BO_MODELS += [
    {
        "template_object": RandomTemplate(),
        "name_experiment": "Optuna (Random init)",
        "bo_type": "bo_optuna",
    }
]
ALL_BO_MODELS += [
    {
        "template_object": RandomTemplate(),
        "name_experiment": "Random (Random init)",
        "bo_type": "bo_random",
    }
]
ALL_BO_MODELS += [
    {
        "template_object": RandomTemplate(),
        "name_experiment": "HEBO (Random init)",
        "bo_type": "bo_hebo",
    }
]
ALL_BO_MODELS += [
    {
        "template_object": RandomTemplate(),
        "name_experiment": "DNGO (Random init)",
        "bo_type": "bo_dngo",
    }
]
...
if __name__ == "__main__":
    ...
    if run_config in ["bayesmark_clf", "bayesmark_reg"]:
        ...
        run_bayesmark(
            LIST_MODELS_BAYESMARK,
            LIST_DATASETS,
            LIST_METRICS,
            all_dict_templates=ALL_BO_MODELS,
            n_repetitions=NUM_SEEDS,
            n_runs=NUM_RUNS,
            n_init=NUM_INIT,
        )
        ...
        run_tabular(
            LIST_MODELS_HPOBENCH,
            LIST_DATASETS_HPOBENCH,
            all_dict_templates=ALL_BO_MODELS,
            n_repetitions=NUM_SEEDS,
            n_runs=NUM_RUNS,
            n_init=NUM_INIT,
