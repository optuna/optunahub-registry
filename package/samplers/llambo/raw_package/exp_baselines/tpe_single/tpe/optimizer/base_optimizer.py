...
from tpe.utils.utils import get_random_sample
from tpe.utils.utils import revert_eval_config
...
class BaseOptimizer(metaclass=ABCMeta):
    ...
    def initial_sample(self) -> Dict[str, Any]:
        ...
        """
        eval_config = {
            hp_name: self._get_random_sample(hp_name=hp_name) for hp_name in self._hp_names
        }
