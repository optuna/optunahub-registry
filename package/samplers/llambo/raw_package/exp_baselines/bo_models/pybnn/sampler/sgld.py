...
class SGLD(Optimizer):
    ...
    def __init__(self, params, lr: np.float64 = 1e-2, scale_grad: np.float64 = 1) -> None:
        ...
        defaults = dict(lr=lr, scale_grad=scale_grad)
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for parameter in group["params"]:
                ...
                delta = 0.5 * lr * gradient + sigma * torch.normal(
