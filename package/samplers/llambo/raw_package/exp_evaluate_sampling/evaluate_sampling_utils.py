...
def sample_from_GP(
    hp_constraints, lower_is_better, num_candidates, observed_configs, observed_fvals
):
    """Sample from GP"""
    seed = 42
...
def sample_from_TPESampler(
    ...
    sampler = TPESampler(
        multivariate=model_covariance,  # doing independent sampling if False, else multivariate
